...
function readPostFields(formData: FormData) {
  ...
  return {
    ...
    title_de: (formData.get("title_de") as string) || null,
    ...
    content_de: (formData.get("content_de") as string) || null,
    ...
    meta_title_de: (formData.get("meta_title_de") as string) || null,
    meta_description_de: (formData.get("meta_description_de") as string) || null,
  };
}
